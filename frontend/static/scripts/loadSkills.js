document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchSkillNames() {
        return fetch('https://dndapi.pythonanywhere.com/api/data/skills.json')
    ...
    function fetchBackgroundData (event) {
        ...
        fetch('https://dndapi.pythonanywhere.com/api/data/backgrounds.json')
            .then(response => response.json())
            .then(data => {
    ...
    function fetchRaceData (event) {
        ...
        fetch('https://dndapi.pythonanywhere.com/api/data/races.json')
            .then(response => response.json())
            .then(data => {
